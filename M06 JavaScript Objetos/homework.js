...
/* var michi = crearGato("michi", 4);
console.log(michi.meow()); */
...
var usuario1 = nuevoUsuario("alvaro", "corre15", "hola123");
...
function sumarLikesDeUsuario(objetoUsuario) {
  ...
  // Tu código:
  var suma = objetoUsuario.posts.reduce(function (acum, post) {
